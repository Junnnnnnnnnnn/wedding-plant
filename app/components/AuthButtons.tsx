...
function AuthButton({ label, className }: { label: string; className: string }) {
  return (
    <button
      type="button"
...
export function AuthButtons({ guestLabel = "로그인 없이 둘러보기" }: AuthButtonsProps) {
  return (
    <div className="animate-rise-delayed w-full max-w-[320px] pb-10">
      <div className="flex flex-col items-center gap-3">
        <AuthButton label="네이버로 시작하기" className="bg-[#03c75a] text-white" />
        <AuthButton label="카카오로 시작하기" className="bg-[#FEE500] text-[#191919]" />
