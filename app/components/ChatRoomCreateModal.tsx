    ...
    const handleSubmit = async () => {
        ...
        try {
            ...
            if (res.ok) {
                ...
                setError(data.message || "채팅방 생성에 실패했습니다. 다시 시도해 주세요.");
            }
        } catch {
        ...
        >
            ...
            >
                <div className="flex justify-between items-center mb-8">
                    <div>
                        <h2 className="text-2xl font-black text-[#1b0d14]">새 채팅방 만들기</h2>
                        <p className="text-gray-400 font-bold text-xs mt-1">우리만의 소중한 대화 채널을 추가해보세요</p>
                    </div>
                    <button
                        onClick={onClose}
